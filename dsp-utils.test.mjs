...
test('sanitizeUrl handles unsafe protocols', () => {
...
test('sanitizeUrl handles safe URLs', () => {
  ...
  assert.equal(sanitizeUrl('?query=test'), '?query=test');
});

test('sanitizeUrl handles null/empty inputs', () => {

...
## 2026-07-01 - [Inaccessible custom toggle switches due to duplicate IDs]
...
## 2026-07-01 - Confirmation for Destructive Actions
**Learning:** Destructive user actions (like deleting individual recordings) without explicit confirmation dialogs lead to accidental data loss and poor user experience.
**Action:** Consistently enforce explicit confirmation dialogs (e.g., using \`window.confirm()\`) before executing deletion actions.

...
## 2026-06-26 - Add confirmation dialog for delete action
**Learning:** Added a native `window.confirm` dialog to prevent accidental deletion of individual user audio recordings.
**Action:** Always include confirmation dialogs for destructive actions like deleting user data to improve UX and prevent data loss.

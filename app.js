...
class VoxBallGame {
  ...
  drawVoiceCanvasScene(prosodyGlow) {
    ...
    ctx.textAlign = 'left';
    // Optimization: Avoid allocating objects and an array in this 60fps render loop
  ...
  _drawPrismPitchSparkline(canvasEl) {
    ...
    // Optimization: Avoid intermediate array allocation with .map

...
class VoxBallGame {
  ...
  setupUI() {
    ...
    pauseCanvasBtn?.addEventListener('click', () => {
      ...
      pauseCanvasBtn.setAttribute('aria-pressed', this.voiceCanvasPaused);
    });
    ...
    if (cbBtn) {
      cbBtn.addEventListener('click', () => {
        ...
        cbBtn.setAttribute('aria-pressed', this.colorblindMode);
      });
    }
    ...
    const syncMotionToggleLabel = () => {
      ...
      motionToggle.setAttribute('aria-pressed', this.userMotionPreference === 'low');
    };
    ...
    if (vibMaster) {
      vibMaster.addEventListener('change', () => {
        ...
        if (vibBtn) {
          ...
          vibBtn.setAttribute('aria-pressed', vibMaster.checked);
        }
      });
    }

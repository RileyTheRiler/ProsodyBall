...
const PITCH_GUIDE_VALUES = [100, 150, 200, 250, 300]; // Static guides to prevent per-frame allocation
...
class VoxBallGame {
  ...
  drawVoiceCanvasScene(prosodyGlow) {
    ...
    // ⚡ Bolt Optimization: Pre-allocated guides and traditional for-loop to reduce GC pressure

...
export class VoxBallGame {
  ...
  _drawPhraseSpark(canvas, series, words) {
    ...
    // ⚡ Bolt: Calculate min/max in a single loop to avoid intermediate array allocation
    // and prevent stack overflow from spreading large arrays into Math.min/max

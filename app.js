...
class VoxBallGame {
  ...
  _drawPrismPitchSparkline(canvasEl) {
    const pr = this.prismReader;
    // ⚡ Bolt Optimization: Single-pass loop to find crystallized syllables and compute min/max pitches
    const crystallized = [];
    let minP = Infinity;
    let maxP = -Infinity;
    ...
    // Fallback if no valid pitches found, though array length check above handles it

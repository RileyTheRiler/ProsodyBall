...
const CANVAS_PITCH_GUIDES = [100, 150, 200, 250, 300]; // Static pitch guides for Voice Canvas to prevent GC spikes
...
class VoxBallGame {
  ...
  drawVoiceCanvasScene(prosodyGlow) {
    ...
    // ⚡ Bolt Optimization: Use standard for loop with hoisted static array to prevent GC spikes in per-frame rendering

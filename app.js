...
class VoxBallGame {
  ...
  setupUI() {
    ...
    const syncMotionToggleLabel = () => {
      ...
      const isLowMotion = this.userMotionPreference === 'low';
      motionToggle.classList.toggle('active', isLowMotion);
      motionToggle.setAttribute('aria-pressed', isLowMotion ? 'true' : 'false');
    };

...
class VoxBallGame {
  ...
  renderTeleprompter(dt) {
    ...
    // ⚡ Bolt Optimization: Cache parsed words to prevent GC pressure and function overhead
    ...
    // ⚡ Bolt Optimization: Skip DOM manipulation if the active word hasn't changed
    if (this._teleprompterLastActive === active && this._teleprompterLastText === sourceText) {
      return;
    }
    this._teleprompterLastActive = active;
    this._teleprompterLastText = sourceText;
